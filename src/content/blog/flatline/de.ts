...
const article: BlogArticle = {
  slug: 'flatline',
  lang: 'de',
  title: 'Die Flatline: Warum du nach dem Aufhören nichts mehr fühlst — und warum das kein Schaden ist',
  description:
    'Ein paar Wochen nach dem Aufhören: Libido auf null, graue Stimmung, keine Motivation? Das ist die Flatline. Was sie ist, wie lange sie dauert, und der eine Fehler, der sie neu startet.',
  ...
  blocks: [
    ...
    {
      kind: 'p',
      text: 'Nicht jeder bekommt alles davon, und manche erleben kaum eine Flatline. Andere trifft es hart. Keine Formel sagt vorher, zu welcher Gruppe du gehörst — nur dass ein längerer und intensiverer Konsum in der Regel ein tieferes Tal bedeutet.',
    },
    { kind: 'h2', text: 'Wie lange dauert sie?' },
    {
      kind: 'p',
