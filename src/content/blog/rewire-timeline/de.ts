...
/**
 * German version — conversational "du" register, idiomatic rewrite (not a
 * literal translation of en.ts).
 */
const article: BlogArticle = {
  slug: 'rewire-timeline',
  lang: 'de',
  title: 'Wie lange braucht dein Gehirn, um sich von Pornos zu erholen? Der ehrliche Zeitplan',
  description:
    'Der echte Reboot-Zeitplan, Woche für Woche — inklusive der Flatline, vor der dich niemand warnt. Keine Wunderdaten, nur was wirklich passiert und wann.',
  ...
  blocks: [
    ...
    { kind: 'h2', text: 'Was „Neuverdrahtung“ eigentlich bedeutet' },
    {
      kind: 'p',
      text: 'Jahre intensiven Konsums trainieren dein Belohnungssystem auf eine simple Schleife: Auslöser, Dopaminspitze, Entladung, von vorn. Wiederhol das ein paar tausend Mal, und dein Gehirn macht, was Gehirne mit stark wiederholtem Verhalten immer machen — es verstärkt diese Bahnen und dreht leise die Lautstärke von allem anderen herunter. Gewöhnliche Belohnungen fühlen sich plötzlich fad an. Diese Fadheit hat in der Forschungsliteratur einen Namen: Desensibilisierung.',
    },
    {
      kind: 'p',
      text: 'Neuverdrahtung ist der umgekehrte Prozess. Du hörst auf, die Schleife zu füttern, die Bahnen schwächen sich mangels Nutzung ab, und deine Empfindlichkeit für normale Belohnungen kehrt langsam zurück. Das ist Neuroplastizität, die ausnahmsweise für dich arbeitet. Sie ist real, sie ist in der Suchtforschung allgemein gut belegt, und sie ist langsam — weil du keine Gewohnheit löschst, sondern darauf wartest, dass ein Trampelpfad durch einen Wald wieder zuwächst.',
    },
    { kind: 'h2', text: 'Der Zeitplan, Phase für Phase' },
    { kind: 'h3', text: 'Tag 1–14: die laute Phase' },
    {
      kind: 'p',
      text: 'Die ersten zwei Wochen sind meist die lautesten. Der Drang kommt in Wellen, oft zu sehr vorhersehbaren Zeiten — der späte Abend ist das klassische Risikofenster. Der Schlaf kann aus dem Takt geraten. Stimmungsschwankungen sind häufig. Manche werden auf eine Art reizbar, die sie selbst überrascht.',
    },
    {
      kind: 'p',
      text: 'Nichts davon bedeutet, dass etwas kaputt ist. Es bedeutet, dass die Schleife gemerkt hat, dass du sie nicht mehr fütterst. Ein Drang ist kein Befehl, sondern eine Welle — sie steigt, erreicht ihren Höhepunkt und ebbt in etwa zehn bis zwanzig Minuten ab, ob du nachgibst oder nicht. Die nützlichste Fähigkeit im ganzen Prozess ist, eine einzige Welle auszusitzen. Nur eine. Danach weißt du, dass sie enden, und jede weitere Welle wird verhandelbar.',
    },
    ...
    {
      kind: 'p',
      text: 'Diese Prüfung ist ein Rückfall. Beiß nicht an.',
    },
    {
      kind: 'p',
      text: 'Die Flatline wird von Aufhörenden massenhaft berichtet, und die vernünftigste Lesart ist: Sie ist das Tal der Desensibilisierung — das alte, künstlich laute Signal ist weg, und das normale Signal ist noch nicht zurück. Das kann Tage oder Wochen dauern. Wer weiß, dass die Flatline kommt, kommt meistens durch. Wer noch nie davon gehört hat, deutet sie meist als Scheitern und wird rückfällig, „um zu testen“. Dieser Absatz existiert, damit du zur ersten Gruppe gehörst.',
    },
    { kind: 'h3', text: 'Woche 6–12: die Ruhe kehrt zurück' },
    {
      kind: 'p',
      text: 'Hier beginnen sich die guten Berichte zu häufen. Die Morgen fühlen sich weniger schwer an. Musik klingt besser — das erwähnen erstaunlich viele. Die Konzentration hält länger. Anziehung zu echten Menschen fühlt sich wieder wie ein Signal an statt wie eine Erinnerung. Der Drang taucht noch auf, aber er klopft eher an, statt wie eine Sirene zu heulen.',
    },
    {
      kind: 'p',
      text: 'Das ist ironischerweise auch die zweitgefährlichste Strecke. Sich besser zu fühlen macht leichtsinnig — „ich bin praktisch geheilt“ ist der Gedanke, der einer erschreckenden Zahl von Rückfällen in Woche 9 vorausgeht. Und der Chaser-Effekt (ein starker Drang, in den ein, zwei Tagen nach einem einzelnen Ausrutscher durchzudrehen) ist in dieser Phase noch voll geladen.',
    },
    { kind: 'h3', text: 'Monat 3–6 und darüber hinaus: Konsolidierung' },
    {
      kind: 'p',
      text: 'Nach der 90-Tage-Marke sind die meisten lauten Symptome verschwunden, und die Arbeit ändert ihren Charakter. Es geht nicht mehr darum, den Drang zu überleben, sondern darum, den alten Pfad bei Stress, Langeweile, Schlaflosigkeit, Einsamkeit nicht wieder zu beschreiten — was auch immer dein persönlicher Auslöser von Anfang an war. Langjährige, intensive Nutzer sollten ehrlicherweise mit einem längeren Bogen rechnen, manchmal einem Jahr oder mehr — und das ist kein Defekt. Eine zehn Jahre lang geübte Schleife wird in neunzig Tagen nicht vollständig still.',
    },
    { kind: 'h2', text: 'Was das Datum wirklich verschiebt' },
    {
      kind: 'list',
      items: [
